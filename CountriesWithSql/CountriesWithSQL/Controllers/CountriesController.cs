...
namespace CountriesWithSQL.Controllers
{
    public class CountriesController : Controller
    {
        private readonly CountriesWithSQLContext _context;

        public CountriesController(CountriesWithSQLContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Country != null ? 
                          ...
                          Problem("Entity set 'CountriesWithSQLContext.Country'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CountriesWithSQLContext.Country'  is null.");
            }
            var country = await _context.Country.FindAsync(id);
            if (country != null)
            {
